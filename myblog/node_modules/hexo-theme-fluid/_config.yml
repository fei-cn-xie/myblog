...
utterances:
  repo: fei-cn-xie/fei-cn-xie.github.io
  issue_term: pathname
  label: utterances
  theme: github-light
...
about:
  enable: true
  banner_img: /img/roof.jpg
  banner_img_height: 60
  banner_mask_alpha: 0.1
  avatar: /img/IMG_5038.jpeg
  name: "Fei"
  intro: "Everything that kills me makes me feel alive"
  # 更多图标可从 https://hexo.fluid-dev.com/docs/icon/ 查找，`class` 代表图标的 css class，添加 `qrcode` 后，图标不再是链接而是悬浮二维码
  # More icons can be found from https://hexo.fluid-dev.com/docs/en/icon/  `class` is the css class of the icon. If adding `qrcode`, The icon is no longer a link, but a hovering QR code
  icons:
    - { class: "iconfont icon-github-fill", link: "https://https://github.com/fei-cn-xie", tip: "GitHub" }
...
static_prefix:
  ...
  internal_css: /css
  internal_img: /img
  live2d_auto: /live2d-widget/autoload.js
